"""
Django settings for django_drf_api project.
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [(
        ...
        # sätter antaler bilder begränsat till 5 och omformaterar date formatet
...
REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'django_drf_api.serializer.CurrentUserSerializer'
}
...
CSRF_TRUSTED_ORIGINS = ['https://8000-myekman-djangorest-wrv9tc7u1ap.ws-eu104.gitpod.io', 'https://django-rest-framework3-cd622c575206.herokuapp.com']
...
WSGI_APPLICATION = 'django_drf_api.wsgi.application'
